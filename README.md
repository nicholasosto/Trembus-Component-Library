...
| [`@trembus/ui`](packages/ui#readme)             | [![npm](https://img.shields.io/npm/v/@trembus/ui.svg)](https://www.npmjs.com/package/@trembus/ui)             | The component library — primitives (`Box` / `Stack` / `Text` / `Pressable`), form controls, overlays, and Tier-1 data viz (charts, `Heatmap`, `DecisionMap`, …). Depends on `@trembus/tokens`.                                                                                                                      |
