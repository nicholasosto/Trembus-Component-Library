...
| `workflow-board` (WorkflowBoard) | 1.1.0   | `templates/pages/src/WorkflowBoard/` | `WorkflowBoard.tsx`                              | toolbar-actions · inspector                                                                                | Workflow working surface: DataStatusBar + toolbar + Switch-toggled RunHistory + time-travelling Swimlane.           |
